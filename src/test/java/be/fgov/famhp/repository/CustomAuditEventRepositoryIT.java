package be.fgov.famhp.repository;

import be.fgov.famhp.AmqpConsoleApplicationApp;
import be.fgov.famhp.config.Constants;
import be.fgov.famhp.config.TestSecurityConfiguration;
import be.fgov.famhp.config.audit.AuditEventConverter;
import be.fgov.famhp.domain.PersistentAuditEvent;
...
import static be.fgov.famhp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
